      ...
      <div className="w-full flex flex-col gap-5 text-white pt-4 pb-6 px-2">
        ...
        <div className="relative bg-dark-600 border border-border-glass rounded-2xl p-6 overflow-hidden">
          ...
          <div className="flex items-center gap-4 mt-6 relative z-10">
            ...
            {/* DEPOSIT BUTTON - Uses Purple/Pink Gradient */}
            <button className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-accent-purple to-accent-pink hover:from-accent-pink hover:to-accent-purple text-white py-3 rounded-xl font-semibold text-[13px] shadow-lg shadow-accent-purple/30 transition-all duration-300 hover:-translate-y-0.5">
              <FaArrowDown className="text-white/60 text-xs" />
              Deposit
            </button>

            {/* WITHDRAW BUTTON - Uses Premium Gold */}
            <button className="flex-1 flex items-center justify-center gap-2 bg-accent-gold hover:bg-accent-gold/80 text-dark-900 py-3 rounded-xl font-semibold text-[13px] shadow-lg shadow-accent-gold/30 transition-all duration-300 hover:-translate-y-0.5">
              <FaArrowUp className="text-dark-900/60 text-xs" />
              Withdraw
            </button>
        ...
        <div className="w-full">
              ...
              return (
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-[11px] font-medium transition-all duration-200 ${
                    isActive
                      ? 'bg-accent-lime text-dark-900 shadow-sm'
          ...
          <div className="bg-dark-600 border-2 border-dashed border-border-glass rounded-2xl py-12 px-6 flex flex-col items-center justify-center gap-3">
            ...
            <button className="mt-2 bg-accent-lime hover:bg-accent-lime/80 text-dark-900 px-6 py-2 rounded-full font-semibold text-[12px] shadow-lg shadow-accent-lime/20 transition-all duration-300 hover:scale-105">
